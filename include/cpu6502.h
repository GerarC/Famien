 ...
 *
 * Initial values are all zero and the lookup that is the data base of
 * instructions
 *
 * input:
...
/*
 * Reads the program counter and executes the instruction of the retrieved
 * opcode
 *
 * input:
...
/*
 * Sets a flag in the cpu if v is true, else sets a 0 in the flag status
 * position
 *
 * Input:
 *  cpu: needed cpu
